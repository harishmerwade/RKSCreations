...
const WhyChoose: React.FC<WhyChooseProps> = ({ setView }) => {
  ...
  const whatsappText = encodeURIComponent('Hello RKS Creations, I would like to discuss your exclusive product range.');
        ...
        <div className="flex items-center justify-between mb-16 px-8">
          <div className="max-w-2xl">
            ...
            >
              ...
              <span className="text-blue-600 font-[900] tracking-[0.5em] uppercase text-[10px] mobile-lg-text">Brand Experience</span>
            </motion.div>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-gradient-to-r from-[#1faa59] via-[#25D366] to-[#128C7E] text-white px-12 py-6 rounded-[28px] font-black uppercase tracking-[0.3em] text-[11px] shadow-2xl shadow-emerald-200 flex items-center gap-5 group hover:brightness-95 transition-all"
          >
      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="text-center mb-24">
          ...
          >
            ...
            <span className="text-blue-600 font-black tracking-[0.5em] uppercase text-[10px] mobile-lg-text">Excellence in Every Detail</span>
            <span className="w-10 h-[1px] bg-blue-200"></span>
          </motion.div>
