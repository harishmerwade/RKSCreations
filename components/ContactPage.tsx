              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <div className="w-full h-80 bg-slate-800 rounded-[50px] overflow-hidden border border-white/5 relative group mb-12 shadow-2xl">
                    <iframe 
                      src={mapsEmbedLink}
                      className="w-full h-full grayscale invert hue-rotate-[190deg] contrast-[1.2] opacity-50 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none"
                      style={{ border: 0 }}
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="absolute z-20 bottom-8 left-8 bg-blue-600 px-6 py-3 rounded-2xl flex items-center gap-3 shadow-xl hover:bg-blue-500 transition-colors"
                    >
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.99 }}
                  className="mt-10 block rounded-[34px] p-8 bg-gradient-to-r from-[#1faa59] via-[#25D366] to-[#128C7E] text-white shadow-2xl shadow-emerald-900/30 border border-white/10 group"
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-[10px] font-black uppercase tracking-[0.4em] text-white/80">Quick Chat Channel</span>
                      <h4 className="text-3xl font-black tracking-tight mt-3">Connect on WhatsApp</h4>
                      <p className="text-base font-semibold text-white/90 mt-2">Instant replies for product quotes and consultation.</p>
                    </div>
                    <div className="w-16 h-16 rounded-2xl bg-white/15 border border-white/30 flex items-center justify-center group-hover:bg-white group-hover:text-emerald-700 transition-all">
