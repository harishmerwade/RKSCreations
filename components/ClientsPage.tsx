          ...
          <div className="grid grid-cols-4 gap-px bg-slate-100 border border-slate-100 rounded-[60px] overflow-hidden shadow-2xl shadow-slate-200">
            {LOGOS.map((client, i) => (
              <motion.div 
                ...
                className="bg-white p-8 flex items-center justify-center group relative overflow-hidden h-64 transition-all duration-500 hover:shadow-[inset_0_0_40px_rgba(37,99,235,0.03)]"
              >
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-center transition-all duration-700">
                  <motion.img 
                    ...
                    className="max-w-[94%] max-h-[94%] object-contain opacity-100 transition-all duration-500"
                  />
                </div>
