    ...
    <section id="products" className="py-32 px-20 bg-white">
      <div className="flex justify-between items-end mb-24">
        <div className="max-w-xl">
          <span className="text-blue-600 font-black tracking-[0.4em] uppercase text-xs block mb-6 mobile-lg-text">Our Portfolio</span>
          <h2 className="text-6xl font-[900] text-slate-900 tracking-tighter leading-tight">Masterpieces <br /> of Brand Craft.</h2>
        </div>
        <motion.button 
          onClick={() => setView('products')}
          whileHover={{ x: 10 }}
          className="text-slate-400 font-black uppercase tracking-[0.3em] text-[10px] flex items-center gap-4 hover:text-blue-600 transition-colors mobile-lg-large"
        >
