      ...
      <div className="max-w-[1440px] mx-auto px-24">
        ...
        <div className="mb-40">
          <div className="flex justify-between items-end mb-20">
            <div>
              <span className="text-blue-600 font-black tracking-[0.4em] uppercase text-[10px] mb-4 block">Our Promise</span>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-slate-50 rounded-[60px] p-24 text-center border border-slate-100 relative overflow-hidden group"
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-24 bg-gradient-to-b from-blue-600 to-transparent" />
          <h4 className="text-5xl font-[950] text-slate-900 mb-8 leading-tight tracking-tighter">
          ...
          <div className="flex items-center justify-center gap-8">
            <button 
              onClick={() => setView('contact')}
              className="bg-blue-600 text-white px-12 py-6 rounded-2xl font-black uppercase tracking-widest text-xs shadow-2xl shadow-blue-200 hover:bg-blue-700 transition-all flex items-center gap-4"
            >
              Get In Touch <MessageSquare size={18} />
            </button>
            <div className="flex flex-col items-start text-left">
              <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest">Enquiry Hotline</span>
              <span className="text-lg font-black text-slate-900">+91 90363 33005</span>
            </div>
          </div>
        </motion.div>
