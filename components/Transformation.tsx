...
const MasterpieceJourney: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[600px] flex items-center justify-center overflow-hidden bg-slate-50/50 rounded-[60px] border border-slate-100 shadow-inner">
          ...
          <div key={i} className="flex items-center gap-4 justify-end">
            {step === i && (
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="text-right">
                <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest">{stepText[i-1].title}</p>
              </motion.div>
            )}
      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="flex justify-between items-end mb-20">
          <div className="max-w-4xl">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} className="flex items-center gap-5 mb-6">
               ...
               <span className="text-blue-600 font-[900] tracking-[0.6em] uppercase text-[11px]">Advanced Manufacturing Journey</span>
            </motion.div>
        ...
        <div className="mt-20 flex justify-between items-center bg-slate-900 p-12 rounded-[50px] text-white">
           ...
           <motion.button 
             ...
             className="bg-blue-600 px-12 py-6 rounded-3xl font-[950] uppercase tracking-widest text-[11px] flex items-center gap-4 group"
           >
