        ...
        >
          {[...offerings, ...offerings, ...offerings].map((item, i) => (
            <div key={i} className="flex items-center gap-10 group cursor-default">
              <span className="text-base md:text-[11px] font-black text-[rgb(37,99,235)] md:text-slate-300 tracking-[0.5em] uppercase transition-colors group-hover:text-blue-600">
                {item}
              </span>
        ...
        <div className="max-w-[1440px] mx-auto grid grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-5">
              ...
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.5em] mobile-lg-text">STRATEGIC PURPOSE</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-5">
              ...
              <span className="text-[10px] font-black text-blue-100 uppercase tracking-[0.5em] mobile-lg-text">FUTURE TRAJECTORY</span>
            </div>
          </motion.div>
        </div>
      </section>
